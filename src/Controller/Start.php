...
class Start extends General
{
    ...
    public function indexAction()
    {
        ...
        return $this->render(
            '@Modules/moloniprestashopes/src/View/Templates/Admin/Orders.twig',
            [
    ...
    public function clearInvoice()
    {
        ...
        if (empty($orderId)) {
            $this->addFlash('warning', $this->trans('Received id is empty!!', 'Modules.Moloniprestashopes.Errors'));
